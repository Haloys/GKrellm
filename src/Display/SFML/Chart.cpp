...
Display::Chart::Chart(sf::Vector2f size) : _size(size)
{
...
void Display::Chart::setData(const std::vector<float> &data, bool difColor)
{
    _bars.clear();
...
void Display::Chart::draw(sf::RenderWindow &window)
{
